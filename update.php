...
<h3>Update all Students</h3>
		...
		<table>
			...
			<tr>
                ...
                <th width="100px">Delete<br><hr></th>
      ...
      <th>{$row['SurName']}</th>
              ...
              <th>{$row['Email']}</th>
              <th>{$row['Contact']}</th>
              <th><a  href='updateinfo.php?student&eoiwcjoiwmcowiecwec=$row[Student_ID]'>Update</a>
...
;echo '
      ...
      <th>{$row['SurName']}</th>
              ...
              <th>{$row['Email']}</th>
              <th>{$row['Contact']}</th>
              <th><a  href='updateinfo.php?4w8948fjifwefwef=$row[Parent_ID]'>Update</a>
    ...
    else if(isset($_GET["teacher"]))
    {
      ...
      <th>{$row['SurName']}</th>
              ...
              <th>{$row['Email']}</th>
              <th>{$row['Contact']}</th>
              <th><a  href='updateinfo.php?ewfewf3445445=$row[Teachers_ID]'>Update</a>
			</tr>";
			}
			;echo '      
              </table>
    ...
    else if(isset($_GET["class"]))
    {
      ...
      <th><a  href='updateinfo.php?knug787g8fttyrr=$row[Class_ID]'>Update</a>
			</tr>";
			}
			;echo '           </table>
              </body>
