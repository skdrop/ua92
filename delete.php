...
<h3>See all Students</h3>
      ...
      <th>{$row['SurName']}</th>
              ...
              <th>{$row['Email']}</th>
              <th>{$row['Contact']}</th>
              <th><a  href='loading.php?eoiwcjoiwmcowiecwec=$row[Student_ID]'>Delete</a>
...
;echo '
      ...
      <th>{$row['SurName']}</th>
              ...
              <th>{$row['Email']}</th>
              <th>{$row['Contact']}</th>
              <th><a  href='loading.php?4w8948fjifwefwef=$row[Parent_ID]'>Delete</a>
    ...
    else if(isset($_GET["teacher"]))
    {
      ...
      <th>{$row['SurName']}</th>
              ...
              <th>{$row['Email']}</th>
              <th>{$row['Contact']}</th>
              <th><a  href='loading.php?ewfewf3445445=$row[Teachers_ID]'>Delete</a>
			</tr>";
			}
			;echo '      
              </table>
    ...
    else if(isset($_GET["class"]))
    {
      ...
      <th><a  href='loading.php?knug787g8fttyrr=$row[Class_ID]'>Delete</a>
			</tr>";
			}
			;echo '           </table>
              </body>
